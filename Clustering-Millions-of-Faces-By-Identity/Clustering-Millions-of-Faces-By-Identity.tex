...
The method uses a representation that needs to be distributed in chunks across servers, each one process about a million image instances. However, the authors don't provide an efficient algorithm for merging the results.

\hypertarget{future-work}{%
\subsubsection{Future Work}\label{future-work}}

Otto mentions that it would be beneficial to enforce pairwise constraints like must-link and cannot-link.
