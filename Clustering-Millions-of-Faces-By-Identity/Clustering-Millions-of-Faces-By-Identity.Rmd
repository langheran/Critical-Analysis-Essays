...
The network architecture to produce a 320D feature vector was VGG16 proposed by [@Simonyan2014]. The rank-order clustering algorithm is based on [@zhu2011]. The k-d tree for calculating just the 200-top nearest neighbors is based on [@muja2014]. 
