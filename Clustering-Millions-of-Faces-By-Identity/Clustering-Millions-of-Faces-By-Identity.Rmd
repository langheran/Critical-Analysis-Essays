...
Also, given that the clustering on videos is skewed towards the authors present the results of the algorithm using a sample of 3 frames per video in contrast to the results obtained over all the frames. 

Finally, the authors AAA
